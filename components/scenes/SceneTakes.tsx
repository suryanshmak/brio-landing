        ...
        <div style={{ borderRadius: '22px', border: '1px solid var(--panelbrd)', background: 'linear-gradient(180deg,var(--panel1),var(--panel2))', boxShadow: '0 40px 90px -50px var(--shadow1)', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', borderRadius: '14px', border: '1px solid var(--line)', background: 'var(--wash)', padding: '12px 14px', opacity: '.55' }}>
              ...
              <svg viewBox="0 0 200 30" preserveAspectRatio="none" style={{ flex: '1', height: '24px', minWidth: '0' }}><path d="M0,15 C18,24 34,6 52,15 S88,26 106,13 S148,4 166,17 S190,22 200,15" fill="none" stroke="var(--ink4)" strokeWidth="2" strokeLinecap="round" /></svg>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', borderRadius: '14px', border: '1px solid var(--acc-brd)', background: 'var(--acc-bg)', padding: '12px 14px', boxShadow: '0 0 34px -14px var(--acc)' }}>
              ...
              <svg viewBox="0 0 200 30" preserveAspectRatio="none" style={{ flex: '1', height: '24px', minWidth: '0' }}><path d="M0,15 C16,4 30,25 48,15 S82,3 100,16 S140,27 158,12 S186,6 200,15" fill="none" stroke="var(--acc)" strokeWidth="2" strokeLinecap="round" /></svg>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', borderRadius: '14px', border: '1px solid var(--line)', background: 'var(--wash)', padding: '12px 14px', opacity: '.55' }}>
              ...
              <svg viewBox="0 0 200 30" preserveAspectRatio="none" style={{ flex: '1', height: '24px', minWidth: '0' }}><path d="M0,15 C20,20 38,8 56,15 S94,23 112,14 S152,7 170,16 S192,19 200,15" fill="none" stroke="var(--ink4)" strokeWidth="2" strokeLinecap="round" /></svg>

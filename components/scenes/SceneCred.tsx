  ...
  return (
    <section id="s-cred" data-vis="cred" data-screen-label="03 Credential" style={{ position: 'relative', overflow: 'clip', padding: '20vh 6vw', background: 'radial-gradient(900px 700px at 80% -8%,var(--g1),transparent 60%),var(--bgC)' }}>
      <div id="credgrid" style={{ position: 'relative', display: 'grid', gridTemplateColumns: '1.05fr .95fr', gap: '6vw', alignItems: 'center', maxWidth: '1340px', margin: '0 auto' }}>
        <div>
          <div data-rise="0" data-scr="" style={{ fontFamily: 'var(--f-mono)', fontSize: '10.5px', letterSpacing: '.26em', color: 'var(--acc-dim)' }}>04 · THE CREDENTIAL</div>
          <h2 data-rise="1" data-disp="" style={{ fontFamily: 'var(--f-disp)', fontWeight: '790', fontStretch: '111%', fontSize: 'clamp(42px,5.6vw,90px)', lineHeight: '.96', letterSpacing: '-.033em', margin: '16px 0 0', textWrap: 'balance' }}>Pass once. <span data-ital="" style={{ color: 'var(--acc-hl)' }}>Carry the proof</span> anywhere.</h2>
          <p data-rise="2" style={{ fontSize: 'clamp(15px,1.5vw,18px)', lineHeight: '1.55', color: 'var(--ink2)', margin: '24px 0 0', maxWidth: '46ch' }}>One un-assisted, on-camera assessment becomes a shareable, verifiable credential, the same signal recruiters discover you by. No grind, no gaming.</p>
          <div data-rise="3" style={{ display: 'flex', alignItems: 'center', gap: '18px', marginTop: '32px', flexWrap: 'wrap' }}>
        ...
        <div style={{ justifySelf: 'center' }}>
          <div data-tilt="" style={{ perspective: '1200px' }}>
            <div data-tiltcard="" style={{ position: 'relative', overflow: 'hidden', width: 'min(460px,88vw)', borderRadius: '26px', padding: '32px', background: 'linear-gradient(150deg,var(--card1),var(--card2) 75%)', border: '1px solid var(--cardbrd)', boxShadow: '0 70px 140px -50px var(--cardglow)', transformStyle: 'preserve-3d', willChange: 'transform' }}>
              ...
              <div data-sheen="" aria-hidden="true" style={{ position: 'absolute', inset: '-40%', background: 'linear-gradient(115deg,transparent 43%,var(--csheen) 50%,transparent 57%)', pointerEvents: 'none', willChange: 'transform' }}></div>
              ...
              <div data-disp="" style={{ fontFamily: 'var(--f-disp)', fontWeight: '770', fontStretch: '110%', fontSize: '34px', color: 'var(--cink)', marginTop: '28px', lineHeight: '1', letterSpacing: '-.02em' }}>Aarav Mehta</div>
              <div style={{ fontFamily: 'var(--f-mono)', fontSize: '10.5px', color: 'var(--cink2)', marginTop: '8px', letterSpacing: '.08em' }}>BACKEND ENGINEER · MID-LEVEL · TARGET STRIPE</div>
              <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginTop: '28px' }}>
                <div style={{ display: 'flex', alignItems: 'flex-end', gap: '16px' }}>
                  ...
                  <div style={{ paddingBottom: '7px' }}>
                    ...
                    <div style={{ fontFamily: 'var(--f-mono)', fontSize: '8.5px', letterSpacing: '.16em', color: 'var(--cink2)' }}>PROVEN SCORE</div>
                  </div>
                </div>
              ...
              <div style={{ marginTop: '26px', borderTop: '1px solid var(--cardline)', paddingTop: '13px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontFamily: 'var(--f-mono)', fontSize: '9.5px', color: 'var(--cink3)', letterSpacing: '.06em' }}>UN-ASSISTED · ON CAMERA</span>
                <span style={{ fontFamily: 'var(--f-mono)', fontSize: '9.5px', color: 'var(--cink3)' }}>brio.so/p/aarav · ID 7F4A</span>
              </div>
            </div>
          </div>

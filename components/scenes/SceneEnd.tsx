  ...
  return (
    <section id="s-end" data-vis="end" data-screen-label="06 Finale" style={{ position: 'relative', minHeight: '105vh', overflow: 'clip', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'radial-gradient(1100px 800px at 50% 110%,var(--bgB),var(--bgA) 70%)' }}>
      ...
      <div style={{ position: 'relative', zIndex: '2', textAlign: 'center', padding: '0 6vw' }}>
        <div data-scr="" style={{ fontFamily: 'var(--f-mono)', fontSize: '10.5px', letterSpacing: '.3em', color: 'var(--acc-dim)', textShadow: 'var(--tsep)' }}>07 · READY WHEN YOU ARE</div>
        ...
        <div style={{ fontFamily: 'var(--f-mono)', fontSize: '10.5px', letterSpacing: '.22em', color: 'var(--ink3)', textShadow: 'var(--tsep)', marginTop: '26px' }}>FREE DIAGNOSTIC · 3 TAKES · PRIVATE BY DEFAULT</div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '14px', marginTop: '34px', flexWrap: 'wrap' }}>
          ...
          <a href="#s-disc" className="hv-brd" style={{ display: 'inline-flex', alignItems: 'center', gap: '9px', border: '1px solid var(--mark)', background: 'var(--wash)', color: 'var(--ink)', borderRadius: '999px', padding: '16px 26px', fontWeight: '600', fontSize: '14.5px', textDecoration: 'none' }}>For recruiters</a>
        </div>
      </div>
    </section>
  );
